...
ActiveRecord::Schema.define(:version => 20130524095214) do
  ...
  add_index "students", ["first_name", "middle_name", "last_name"], :name => "index_students_on_first_name_and_middle_name_and_last_name", :limit => {"last_name"=>nil, "middle_name"=>nil, "first_name"=>nil}
